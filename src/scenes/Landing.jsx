      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Sou um desenvolvedor front-end tenho habilidades em design 
            responsivo, capacidade de trabalhar 
            em equipe. Sempre buscando aprender e se manter
            atualizado com as últimas tecnologias no front-end.
          </p>
        </motion.div>
